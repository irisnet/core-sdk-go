...
func FromTmProtoPublicKey(protoPk tmprotocrypto.PublicKey) (cryptotypes.PubKey, error) {
	...
	case *tmprotocrypto.PublicKey_Ed25519:
		return &ed25519.PubKey{Key: protoPk.Ed25519}, nil
	case *tmprotocrypto.PublicKey_Secp256K1:
		return &secp256k1.PubKey{Key: protoPk.Secp256K1}, nil
	case *tmprotocrypto.PublicKey_Sm2:
		return &sm2.PubKey{Key: protoPk.Sm2}, nil
	default:
...
func ToTmProtoPublicKey(pk cryptotypes.PubKey) (tmprotocrypto.PublicKey, error) {
	switch pk := pk.(type) {
	case *ed25519.PubKey:
		return tmprotocrypto.PublicKey{Sum: &tmprotocrypto.PublicKey_Ed25519{Ed25519: pk.Key}}, nil
	case *secp256k1.PubKey:
		return tmprotocrypto.PublicKey{Sum: &tmprotocrypto.PublicKey_Secp256K1{Secp256K1: pk.Key}}, nil
	case *sm2.PubKey:
		return tmprotocrypto.PublicKey{Sum: &tmprotocrypto.PublicKey_Sm2{Sm2: pk.Key}}, nil
	default:
