...
func (b feegrantClient) QueryAccount(address string) (sdk.BaseAccount, sdk.Error) {
...
func (b feegrantClient) TotalSupply() (sdk.Coins, sdk.Error) {
	conn, err := b.GenConn()
	if err != nil {
...
func (b feegrantClient) Send(to string, amount sdk.DecCoins, baseTx sdk.BaseTx) (sdk.ResultTx, sdk.Error) {
...
func (b feegrantClient) SendWitchSpecAccountInfo(to string, sequence, accountNumber uint64, amount sdk.DecCoins, baseTx sdk.BaseTx) (sdk.ResultTx, sdk.Error) {
	sender, err := b.QueryAddress(baseTx.From, baseTx.Password)
	if err != nil {
		return sdk.ResultTx{}, sdk.Wrapf("%s not found", baseTx.From)
	}
...
func (b feegrantClient) MultiSend(request MultiSendRequest, baseTx sdk.BaseTx) (resTxs []sdk.ResultTx, err sdk.Error) {
	sender, err := b.QueryAddress(baseTx.From, baseTx.Password)
	if err != nil {
...
func (b feegrantClient) SendBatch(sender sdk.AccAddress, request MultiSendRequest, baseTx sdk.BaseTx) ([]sdk.ResultTx, sdk.Error) {
...
func (b feegrantClient) SubscribeSendTx(from, to string, callback EventMsgSendCallback) sdk.Subscription {
