...
import (
	...
	tencrypto "github.com/tendermint/tendermint/crypto"
...
func (privKey PrivKey) PubKey() tencrypto.PubKey {
...
func (privKey PrivKey) Equals(other tencrypto.PrivKey) bool {
...
func (pubKey PubKey) Equals(other tencrypto.PubKey) bool {
